...
csv_file_object = csv.reader(open(os.path.join(os.path.dirname(__file__), 'data', 'train.csv'), 'rb'))       # Load in the csv file
...
# First read in test
test_file = open(os.path.join(os.path.dirname(__file__), 'data', 'train.csv'), 'rb')
